...
const Home = () => {
  const title = "Leatest Blogs";
  const bannerTitle = "Unleash Your Creativity: Artistic Inspiration and Ideas";
  const bannerDescription =
    "Ignite your imagination and tap into your creative potential with inspiring ideas, tips, and resources for artists, writers, and creators of all kinds.";
